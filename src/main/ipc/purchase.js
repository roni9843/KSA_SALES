...
ipcMain.handle('add-purchase', async (event, purchaseData) => {
  const { supplier_id, purchase_date, items, grand_total, discount_amount, tax_amount, grand_total_before_tax, supplier_invoice_no, supplier_invoice_date } = purchaseData;
